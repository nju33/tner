...
var runtime$2 = createCommonjsModule$1(function (module) {
/**
 * Copyright (c) 2014-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
var regenerator$1 = runtimeModule$2;
...
var f$4 = _descriptors$2 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$2(O);
...
var $export$2 = function (type, name, source) {
  ...
  var target = IS_GLOBAL ? _global$2 : IS_STATIC ? _global$2[name] : (_global$2[name] || {})[PROTOTYPE$2];
  var key, own, out;
  if (IS_GLOBAL) source = name;
  for (key in source) {
    // contains in native
...
var assign$1$1 = _core$2.Object.assign;

var assign$3 = createCommonjsModule$1(function (module) {
module.exports = { "default": assign$1$1, __esModule: true };
});

var _Object$assign$1 = unwrapExports$1(assign$3);
...
var createDict$1 = function () {
  ...
  while (i--) delete createDict$1[PROTOTYPE$1$1][_enumBugKeys$2[i]];
  return createDict$1();
};
...
var _objectCreate$2 = Object.create || function create(O, Properties) {
  var result;
  if (O !== null) {
    Empty$1[PROTOTYPE$1$1] = _anObject$2(O);
    result = new Empty$1();
...
var _wks$2 = createCommonjsModule$1(function (module) {
...
var _objectGpo$2 = Object.getPrototypeOf || function (O) {
  O = _toObject$2(O);
  if (_has$2(O, IE_PROTO$2$1)) return O[IE_PROTO$2$1];
  if (typeof O.constructor == 'function' && O instanceof O.constructor) {
    return O.constructor.prototype;
...
var _iterDefine$2 = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      // fix for some old engines
      if (!_library$2 && !_has$2(IteratorPrototype, ITERATOR$4)) _hide$2(IteratorPrototype, ITERATOR$4, returnThis$1);
    }
  }
  // fix Array#{values, @@iterator}.name in V8 / FF
  ...
  // Define iterator
  if ((!_library$2 || FORCED) && (BUGGY$1 || VALUES_BUG || !proto[ITERATOR$4])) {
...
var TAG$1$1 = _wks$2('toStringTag');
// ES3 wrong here
...
var _isArrayIter$2 = function (it) {
  return it !== undefined && (_iterators$2.Array === it || ArrayProto$1[ITERATOR$1$1] === it);
};

var ITERATOR$2$1 = _wks$2('iterator');
...
var _forOf$2 = createCommonjsModule$1(function (module) {
var BREAK = {};
var RETURN = {};
var exports = module.exports = function (iterable, entries, fn, that, ITERATOR) {
  var iterFn = ITERATOR ? function () { return iterable; } : core_getIteratorMethod$2(iterable);
  var f = _ctx$2(fn, that, entries ? 2 : 1);
  var index = 0;
  var length, step, iterator, result;
  if (typeof iterFn != 'function') throw TypeError(iterable + ' is not iterable!');
  // fast case for arrays with default iterator
  if (_isArrayIter$2(iterFn)) for (length = _toLength$2(iterable.length); length > index; index++) {
...
var _speciesConstructor$2 = function (O, D) {
  ...
  var S;
  return C === undefined || (S = _anObject$2(C)[SPECIES$2]) == undefined ? D : _aFunction$2(S);
};
...
if (!setTask$1 || !clearTask$1) {
  ...
  // Node.js 0.8-
  if (_cof$2(process$1$1) == 'process') {
    defer$1 = function (id) {
      process$1$1.nextTick(_ctx$2(run$1, id, 1));
    };
  // Sphere (JS game engine) Dispatch API
  } else if (Dispatch$1 && Dispatch$1.now) {
    defer$1 = function (id) {
      Dispatch$1.now(_ctx$2(run$1, id, 1));
    };
  // Browsers with MessageChannel, includes WebWorkers
    ...
    defer$1 = _ctx$2(port$1.postMessage, port$1, 1);
  // Browsers with postMessage, skip WebWorkers
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    _global$2.addEventListener('message', listener$1, false);
  // IE8-
  } else if (ONREADYSTATECHANGE$1 in _domCreate$2('script')) {
    defer$1 = function (id) {
  ...
  // Rest old browsers
    ...
    defer$1 = function (id) {
      setTimeout(_ctx$2(run$1, id, 1), 0);
    };
  }
}
var _task$2 = {
...
var macrotask$1 = _task$2.set;
var Observer$1 = _global$2.MutationObserver || _global$2.WebKitMutationObserver;
var process$2$1 = _global$2.process;
var Promise$1$1 = _global$2.Promise;
var isNode$1$1 = _cof$2(process$2$1) == 'process';
...
var _microtask$2 = function () {
  ...
  var flush = function () {
    var parent, fn;
    if (isNode$1$1 && (parent = process$2$1.domain)) parent.exit();
    while (head) {
      fn = head.fn;
      head = head.next;
      try {
...
var SPECIES$1$1 = _wks$2('species');

var _setSpecies$2 = function (KEY) {
  var C = typeof _core$2[KEY] == 'function' ? _core$2[KEY] : _global$2[KEY];
  if (_descriptors$2 && C && !C[SPECIES$1$1]) _objectDp$2.f(C, SPECIES$1$1, {
    configurable: true,
    get: function () { return this; }
  });
};

var ITERATOR$3$1 = _wks$2('iterator');
...
var task$1 = _task$2.set;
var microtask$1 = _microtask$2();
...
var isNode$2 = _classof$2(process$3) == 'process';
var empty$1 = function () { /* empty */ };
var Internal$1;
var newGenericPromiseCapability$1;
var OwnPromiseCapability$1;
var Wrapper$1;
var newPromiseCapability$2 = newGenericPromiseCapability$1 = _newPromiseCapability$2.f;
...
var USE_NATIVE$1 = !!function () {
  try {
    ...
    // unhandled rejections tracking support, NodeJS Promise without it fails @@species test
    return (isNode$2 || typeof PromiseRejectionEvent == 'function') && promise.then(empty$1) instanceof FakePromise;
  } catch (e) { /* empty */ }
}();
...
if (!USE_NATIVE$1) {
  ...
  $Promise$1 = function Promise(executor) {
    _anInstance$2(this, $Promise$1, PROMISE$1, '_h');
  ...
  Internal$1.prototype = _redefineAll$2($Promise$1.prototype, {
    // 25.4.5.3 Promise.prototype.then(onFulfilled, onRejected)
    then: function then(onFulfilled, onRejected) {
      var reaction = newPromiseCapability$2(_speciesConstructor$2(this, $Promise$1));
      reaction.ok = typeof onFulfilled == 'function' ? onFulfilled : true;
      reaction.fail = typeof onRejected == 'function' && onRejected;
...
_export$2(_export$2.G + _export$2.W + _export$2.F * !USE_NATIVE$1, { Promise: $Promise$1 });
_setToStringTag$2($Promise$1, PROMISE$1);
_setSpecies$2(PROMISE$1);
Wrapper$1 = _core$2[PROMISE$1];

// statics
_export$2(_export$2.S + _export$2.F * !USE_NATIVE$1, PROMISE$1, {
  // 25.4.4.5 Promise.reject(r)
  reject: function reject(r) {
...
_export$2(_export$2.S + _export$2.F * (_library$2 || !USE_NATIVE$1), PROMISE$1, {
  // 25.4.4.6 Promise.resolve(x)
  resolve: function resolve(x) {
    return _promiseResolve$2(_library$2 && this === Wrapper$1 ? $Promise$1 : this, x);
  }
});
_export$2(_export$2.S + _export$2.F * !(USE_NATIVE$1 && _iterDetect$2(function (iter) {
...
_export$2(_export$2.P + _export$2.R, 'Promise', { 'finally': function (onFinally) {
  var C = _speciesConstructor$2(this, _core$2.Promise || _global$2.Promise);
  var isFunction = typeof onFinally == 'function';
  return this.then(
    isFunction ? function (x) {
      return _promiseResolve$2(C, onFinally()).then(function () { return x; });
    } : onFinally,
    isFunction ? function (e) {
      return _promiseResolve$2(C, onFinally()).then(function () { throw e; });
    } : onFinally
  );
} });
...
var promise$3 = createCommonjsModule$1(function (module) {
module.exports = { "default": promise$1$1, __esModule: true };
});

var _Promise$1 = unwrapExports$1(promise$3);

var asyncToGenerator$1 = createCommonjsModule$1(function (module, exports) {
exports.__esModule = true;



var _promise2 = _interopRequireDefault(promise$3);
...
var _asyncToGenerator$1 = unwrapExports$1(asyncToGenerator$1);
...
var delay$1 = function delay() {
  ...
  return new _Promise$1(function (r) {
    return setTimeout(r, ms);
  });
};

var instantify = (function () {
  var _ref = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee2(el) {
    ...
    return regenerator$1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            return _context2.abrupt("return", _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee() {
...
var Tner = function () {
  function Tner(el) {
    ...
    _classCallCheck(this, Tner);

    this._handleTransitionend = function () {
      _Object$assign(_this.el.style, {
  ...
  _createClass(Tner, [{
    key: '_getWillChangeProps',
    value: function _getWillChangeProps() {
      return _Object$keys(this._to);
    }
  }, {
    key: 'from',
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                _context.next = 6;
                return instantify(this.el);

              case 6:
                pRestore = _context.sent;

                _Object$assign(this.el.style, this._optimisation, this._from);
                _context.next = 10;
                return pRestore();

              case 10:

                _Object$assign(this.el.style, this._optimisation, this._to);
                _context.next = 13;
                return this._delay();
